...
"""
channel_fireball documentation build configuration file.
...
project = 'channel_fireball'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'channel_fireball'
...
#
# html_title = 'channel_fireball v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A test project',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'channel_fireball'),
                os.path.join(root_path, 'channel_fireball/migrations')])
